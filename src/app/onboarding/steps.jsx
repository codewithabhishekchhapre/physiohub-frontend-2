...
import PropTypes from 'prop-types'; // Add this import at the top if you're validating props
        ...
        <div className="flex p-10 flex-col justify-between flex-grow w-full sm:w-[60%] border">
            <div className="flex flex-col w-full">
                <div className="flex justify-start">
                    <ArrowLeft
                        className="text-[#6c4ce6] mr-4 cursor-pointer"
                        size={24}
                        onClick={() => onNext(step - 1)} // Added functionality for back button
                    />
                </div>
